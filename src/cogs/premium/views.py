...
class LegacyView(discord.ui.View):
    def __init__(self, text="This feature is available in Shinchan Legacy for free!"):
    ...
    def legacy_embed(self) -> discord.Embed:
        ...
        _e.set_footer(text="Thank you for being part of the Shinchan Legacy community ❤️")
        return _e
