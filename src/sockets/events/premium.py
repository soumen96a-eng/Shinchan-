...
class SockPrime(Cog):
    ...
    async def on_request__new_premium(self, u, data: dict):
        ...
        _e.description = (
            ...
            "Thanks for purchasing Shinchan Premium.\n\n"
            f"[Invite Shinchan Legacy]({prime}) | [Support Server]({self.bot.config.SERVER_LINK}) | [Download Invoice]({invoice})"
        )
    ...
    #         res = await res.json()
    #         _f = discord.Embed(color=self.bot.color, title="Shinchan x RILP BOT", url=self.bot.config.SERVER_LINK)
    #         _f.description = (
    #             "Shinchan has partnered with Rilp Bot, a multipurpose bot that features Automoderation, "
    #             "Invite Tracking, Starboard, Welcome and Leave messages, Giveaways, Polls, Moderation, "
    #             "Captcha Security, and much more.\n\n"
    #             "With this Shinchan Legacy purchase, you have received **Rilp Bot Premium (30 days)**"
    #             "\n\n__Please follow these steps:__\n"
    #             "➜ Head over to dashboard <https://rilp-bot.tech>\n"
    #             "➜ Login with your discord account from which you bought Shinchan Legacy.\n"
